...
import tech.thdev.androidrecyclerview.ui.github.adapter.GitHubUserSearchAdapter
import tech.thdev.androidrecyclerview.ui.github.presenter.GitHubUserSearchContract
import tech.thdev.androidrecyclerview.ui.github.presenter.GitHubUserSearchPresenter
...
class GitHubUserSearchFragment :
    ...
    override fun showDetailUserInfo(html_url: String) {
        ...
        val customTabsIntent = CustomTabsIntent.Builder().apply {
            ...
            setToolbarColor(resources.getColor(R.color.purple500))
